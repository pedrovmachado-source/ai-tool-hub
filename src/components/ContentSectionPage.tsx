...
import { ArrowLeft, Play, FileText, Image as ImageIcon, Lock, FileText as TextIcon, ShoppingCart, ArrowRight, Sparkles, ExternalLink, Check, Plus } from 'lucide-react';
